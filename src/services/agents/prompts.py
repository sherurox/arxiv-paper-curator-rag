...
- The question requires knowledge from academic papers
- You need context from scientific literature

Do NOT use the tool when:
- The question is about general knowledge unrelated to research
- The question is simple factual or mathematical
- The question is conversational, greeting, or personal
- The question is about topics outside CS/AI/ML research
